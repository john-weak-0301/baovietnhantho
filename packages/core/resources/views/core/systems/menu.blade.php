                ...
                <li class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                        @foreach($availableMenus as $key => $value)
                            <a href="{{ route('systems.menu.show',$key) }}"
...
@section('content')
    <div class="wrapper">
        <div class="dd" data-name="{{$name}}">
            @if(blank($menu))
                <div class="dd-empty" style="display: flex; align-items: center; justify-content: center">
                    <p style="text-align: center">No Menu</p>
                </div>
            @endif
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('Menu Item') }}</h5>
                    ...
                    <div class="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="flex">
                                ...
                                <button type="button" class="btn btn-default btn-sm js-open-link-picker">Open</button>
                            </div>
                            <small class="form-text text-danger none"
                                   id="errors.slug">{{ __('Please fill in the field.') }}</small>
                        </div>

                        @if (request()->is('dashboard/menu/main'))
                            <div class="form-group">
                                <a href="" target="_blank" class="btn btn-default btn-sm js-edit-megamenu">Edit MegaMenu</a>
                            </div>
                        @endif
