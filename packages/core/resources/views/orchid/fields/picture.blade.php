@component($typeForm,get_defined_vars())
    <div data-controller="fields--picture"
        ...
        <div class="b text-right wrapper picture-actions">
            ...
            <span class="mt-1 float-left"></span>

            <label class="btn btn-default m-n">
                <i class="icon-cloud-upload"></i> {{ __('Tải lên') }}
            ...
            <button
                type="button"
                class="btn btn-outline-danger picture-remove"
                data-action="fields--picture#clear">{{ __('Xóa ảnh') }}
            </button>
