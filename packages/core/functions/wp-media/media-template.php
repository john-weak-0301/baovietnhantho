...
function wp_underscore_audio_template() {
	$audio_types = Helper::getAudioExtensions();
	?>
...
function wp_underscore_video_template() {
	$video_types = Helper::getVideoExtensions();
	?>
<#  var w_rule = '', classes = [],
...
function wp_print_media_templates() {
	...
	<script type="text/html" id="tmpl-uploader-inline">
		...
		<?php else : ?>
			...
			<div class="post-upload-ui">
				...
				$max_upload_size = Helper::getMaxUploadSize();
				if ( ! $max_upload_size ) {
					$max_upload_size = 0;
				}
				?>
				...
				<?php
					printf( __( 'Maximum upload file size: %s.' ), esc_html( Helper::sizeFormat( $max_upload_size ) ) );
				?>
				</p>
	...
	<script type="text/html" id="tmpl-audio-details">
		...
		<?php $audio_types = Helper::getAudioExtensions(); ?>
	...
	<script type="text/html" id="tmpl-video-details">
		...
		<?php $video_types = Helper::getVideoExtensions(); ?>
		<div class="media-embed media-embed-details">
