...
class CleanupRules
{
    public static function getRules()
    {
        ...
        $tests = '.travis.yml .scrutinizer.yml phpcs.xml* .php_cs.dist phpcs.php phpunit.xml* phpunit.php test tests Tests travis patchwork.json .github .sami.php';
        ...
        return array(
            ...
            'phpoffice/phpspreadsheet'              => array($docs, $tests, 'samples unitTests changelog.txt'),
